  ...
  <div v-if="!hidden" class="fixed bottom-6 right-6 z-50">
    <div class="relative animate-float">
      ...
      <div class="relative bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-white/50 p-1.5 w-40 hover:shadow-2xl hover:scale-105 transition-all duration-300">
        <div class="mb-0.5">
          <div class="relative">
            <div class="h-5 flex items-center justify-center text-xs font-bold text-gray-800">合作与共创</div>
            <div class="absolute right-0 top-0 h-5 flex items-center gap-0.5">
              <button
                type="button"
          ...
          <div v-if="!collapsed" class="text-center text-[10px] leading-tight text-gray-500 px-0.5">扫码/添加微信号atar24</div>
        </div>
