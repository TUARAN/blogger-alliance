      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><router-link to="/bloggers" class="text-gray-400 hover:text-white transition-colors">博主列表</router-link></li>
            <li><router-link to="/about" class="text-gray-400 hover:text-white transition-colors">关于我们</router-link></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">加入联盟</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li class="text-gray-400">邮箱：contact@blogger-alliance.com</li>
            <li class="text-gray-400">微信：blogger-alliance</li>
            <li class="text-gray-400">QQ群：123456789</li>
          </ul>
        </div>
      </div>
