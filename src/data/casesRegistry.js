...
export const casesHubItems = [
  ...
  },
  {
    ...
    isMock: true,
    badge: '渠道服务',
    blurb: '联盟即云厂商认证渠道：官方充值、按量返利、用量越大阶梯越高。',
...
export const mockCaseModels = {
  ...
  'enterprise-cloud': {
    ...
    intro:
      '这项服务和推文、引流、社群不同——博主联盟本身就是阿里云、腾讯云、华为云、火山引擎的认证渠道商，直接向客户提供官方充值渠道。模式类似「云服务团购」：通过联盟专属链接在官方充值，用多少消费、拿多少返利；用量越大，进入更高返利阶梯。',
    statusBadge: '渠道服务',
    steps: [
      { title: '联盟即渠道', description: '找博主联盟 = 直接走云厂商官方渠道价与返利政策。' },
    ...
    panels: [
      ...
      {
        kicker: 'Service Model',
        title: '传播类 vs 渠道类',
        subtitle: '传播类帮品牌发声，渠道类帮客户买云。',
        lines: [
          '传播类：联盟帮品牌写内容、投点击、运营社群',
